...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center ${"dark:bg-gray-dark dark:shadow-sticky-dark fixed z-[9999] bg-transparent bg-opacity shadow-sticky backdrop-blur-lg transition"
        }`}
      >
